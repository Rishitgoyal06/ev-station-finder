...
const ALL_STATIONS = [
  {
    id: 1, name: "GreenCharge Hub", badge: "Best Match",
    address: "Silicon Valley Tech Park, Block 4, Zone B", city: "Bengaluru, KA",
    distance: "2.1 km", types: ["DC Fast Charger"], connectors: ["CCS2"], hours: "24/7",
    available: 3, total: 5, price: 18, chargeTime: "35 mins", verified: true,
    img: "https://images.unsplash.com/photo-1593941707882-a5bba14938c7?w=400&q=80",
  },
  {
    id: 2, name: "VoltSpark Center", badge: "",
    address: "Gotri Road, Near Bright School", city: "Vadodara, GJ",
    distance: "3.8 km", types: ["AC Charger"], connectors: ["Type 2"], hours: "24/7",
    available: 1, total: 4, price: 12, chargeTime: "50 mins", verified: true,
    img: "https://images.unsplash.com/photo-1568605117036-5fe5e7bab0b7?w=400&q=80",
  },
  {
    id: 3, name: "ChargeIQ Station", badge: "",
    address: "Waghodia Road, Near Amul Dairy", city: "Vadodara, GJ",
    distance: "5.2 km", types: ["DC Fast Charger"], connectors: ["CCS2"], hours: "24/7",
    available: 2, total: 6, price: 20, chargeTime: "40 mins", verified: true,
  ...
  const Sidebar = ({ mobile = false }: { mobile?: boolean }) => (
    <div className={`flex flex-col h-full bg-[#0d0d0d] border-r border-[#1a1a1a] ${mobile ? "w-56" : "w-[200px]"}`}>
      ...
      <div className="mx-3 mb-3 p-3 rounded-xl bg-[#111] border border-[#1a1a1a]">
        <p className="text-[10px] text-[#444] mb-1">My Vehicle</p>
        <p className="text-white text-[12px] font-bold">Tata Nexon EV</p>
        <p className="text-[#555] text-[10px] mb-2">GJ05RC1234</p>
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-white text-[11px] font-bold">28%</span>
        </div>
        <p className="text-[#555] text-[10px] mt-1">Est. Range 84 km</p>
      </div>
