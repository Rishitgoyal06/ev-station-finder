...
import signupAnimation from "@/components/assets/Sign up.json"
  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
            ...
            <FieldGroup>
              ...
              <Field>
                ...
                <FieldDescription className="text-gray-400">
                  We'll use this to send you charging updates and notifications.
                </FieldDescription>
              </Field>
              <Field>
              ...
              <Field>
                <Button type="submit" className="bg-green-500 hover:bg-green-600 text-white font-semibold">
                  Create Account
                </Button>
              </Field>
              ...
              <Field className="grid grid-cols-3 gap-4">
                <Button variant="outline" type="button" className="border-green-500/30 text-white hover:bg-green-500/10">
              ...
              <FieldDescription className="text-center text-gray-400">
                Already have an account? <button type="button" onClick={onLoginClick} className="text-green-500 hover:text-green-400 underline-offset-4 hover:underline bg-transparent border-none p-0 cursor-pointer transition-colors duration-200">Sign in</button>
              </FieldDescription>
            </FieldGroup>
          </form>
      ...
      <FieldDescription className="px-6 text-center text-gray-400">
        By clicking continue, you agree to our <a href="#" className="text-green-500 hover:text-green-400">Terms of Service</a>{" "}
        and <a href="#" className="text-green-500 hover:text-green-400">Privacy Policy</a>.
      </FieldDescription>
    </div>
  )
}