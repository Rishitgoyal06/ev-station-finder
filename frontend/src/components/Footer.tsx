        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-1.5 sm:space-y-2 text-gray-300 text-sm sm:text-base">
              <li><Link href="/stations" className="hover:text-green-200 transition-colors">Find Stations</Link></li>
              <li><Link href="/networks" className="hover:text-green-200 transition-colors">Networks</Link></li>
              <li><Link href="/mobile-app" className="hover:text-green-200 transition-colors">Mobile App</Link></li>
              <li><Link href="/contact" className="hover:text-green-200 transition-colors">Support</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-1.5 sm:space-y-2 text-gray-300 text-sm sm:text-base">
              <li><Link href="/ev-guide" className="hover:text-green-200 transition-colors">EV Guide</Link></li>
              <li><Link href="/ev-guide" className="hover:text-green-200 transition-colors">Charging Tips</Link></li>
              <li><Link href="/stations" className="hover:text-green-200 transition-colors">Route Planner</Link></li>
              <li><Link href="/about" className="hover:text-green-200 transition-colors">Blog</Link></li>
            </ul>
          </div>
