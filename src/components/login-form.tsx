  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
            ...
            <FieldGroup>
              <div className="flex flex-col items-center gap-2 text-center">
                <h1 className="text-2xl font-bold text-white">
                  Welcome back to <span className="text-green-500">Charge</span><span className="text-white">IQ</span>
                </h1>
              ...
              <Field>
                ...
                <FieldDescription className="text-right">
                  <a href="#" className="text-green-500 hover:text-green-400 text-sm">Forgot password?</a>
                </FieldDescription>
              </Field>
              <Field>
      ...
      <FieldDescription className="px-6 text-center text-gray-400">
        By signing in, you agree to our <a href="#" className="text-green-500 hover:text-green-400">Terms of Service</a>{" "}
